package ru.geekbrains.pictureoftheday.viewmodels
...
import ru.geekbrains.pictureoftheday.BuildConfig
import ru.geekbrains.pictureoftheday.network.PODRetrofitImpl
...
class PODViewModel(
    ...
    fun getData(date: String): LiveData<PODData> {
